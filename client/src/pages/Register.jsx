...
import { studentSchema } from "../schema/registerSchema";
                                    ...
                                    <div className="grid grid-cols-1">
                                        <div className="mb-4">
                                            ...
                                            <input
                                                id="RegisterName"
                                                type="text"
                                                className="mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-800 focus:border-orange-900"
                                                value={values?.name}
                                                name="name"
                                        ...
                                        <div className="mb-4">
                                            ...
                                            <div className="form-icon relative mt-2 ">
                                                ...
                                                <input type={showPassword ? "text" : 'password'} className="ps-12 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-800 focus:border-orange-900 " placeholder="Password:"
                                                    autoComplete="on"
                                        ...
                                        <div className="mb-4">
                                            ...
                                            <div className="form-icon relative mt-2 ">
                                                ...
                                                <input type={showConfirmPassword ? "text" : 'password'} className="ps-12 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-800 focus:border-orange-900 " placeholder="Confirm Password:"
                                                    autoComplete="on"
