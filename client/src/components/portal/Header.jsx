 ...
 const [isSidebarOpen, setIsSidebarOpen] = useState(false);
    const toggleSidemenu = () => {
        ...
        if (window.innerWidth >= 992) {
          ...
          console.log(sidemenuType)
        if (sidemenuType === "vertical") {
          const verticalStyle = html.getAttribute("data-vertical-style");
          switch (verticalStyle) {
            case "closed":
              html.toggleAttribute("data-toggled", "close-menu-close");
              break;
            case "overlay":
              html.toggleAttribute("data-toggled", "icon-overlay-close");
              break;
            case "icontext":
              html.toggleAttribute("data-toggled", "icon-text-close");
              break;
            default:
              break;
          }
                ...
                <div className="main-header-container container-fluid">
                    ...
                    <div className="header-content-left">
                        ...
                        <div className="header-element">
                            <div className="horizontal-logo">
                                <a href="index.html" className="header-logo">
                                    {/* <img src="../../src/assets/images/home/logo.png" alt="logo" className="desktop-logo"/>
                            */}
                                    <img src="../../../src/assets/images/logo.png" alt="logo" className="toggle-logo w-6" />
                        ...
                        <div className="header-element mx-lg-0">
                            <button type='button' onClick={toggleSidemenu} aria-label="Hide Sidebar"
                                className="sidemenu-toggle header-link animated-arrow hor-toggle horizontal-navtoggle"
                                data-bs-toggle="sidebar" href="#"><span></span></button>
                        </div>
                        {/* <!-- End::header-element --> */}
                    ...
                    <ul className="header-content-right">
                        ...
                        <li
                            ...
                            <ul className="main-header-dropdown hs-dropdown-menu ti-dropdown-menu min-w-[10rem] hidden"
                                ...
                                <li>
                                    <a className="ti-dropdown-item flex items-center" href="#">
                        ...
                        <li
                            ...
                            <div className="main-header-dropdown hs-dropdown-menu ti-dropdown-menu hidden" data-popper-placement="none">
                                    ...
                                    <li className="ti-dropdown-item block">
                                        <div className="flex items-center">
                                            ...
                                            <div className="grow flex items-center justify-between">
                                                ...
                                                <div>
                                                    <a href="#" className="min-w-fit-content dropdown-item-close1">
                                ...
                                <div className="p-4 empty-header-item1 border-t">
                                    <div className="grid">
                                        <a href="#" className="ti-btn ti-btn-primary btn-wave">View All</a>
                                    </div>
                                </div>
                        ...
                        <li className="header-element header-fullscreen">
                            ...
                            <a onClick={() => { }} href="#" className="header-link">
                        ...
                        <li className="header-element ti-dropdown hs-dropdown">
                            ...
                            <ul className="main-header-dropdown hs-dropdown-menu ti-dropdown-menu pt-0 overflow-hidden header-profile-dropdown hidden"
                                ...
                                <li><a className="ti-dropdown-item flex items-center" href="mail.html"><i
                                    ...
                                    Inbox</a></li>
                                <li><a className="ti-dropdown-item flex items-center" href="file-manager.html"><i
                                ...
                                <li><a className="ti-dropdown-item flex items-center" href="sign-in-cover.html"><i
                        ...
                        <li className="header-element">
                            ...
                            <a href="#" className="header-link switcher-icon" data-hs-overlay="#hs-overlay-switcher">
                                <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 header-link-icon" fill="none"
                                    viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round"
